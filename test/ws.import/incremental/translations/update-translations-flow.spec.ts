...
describe('Translations processing (common flow for entities, datapoints and concepts)', () => {
  it('should create new translations for an entity that was updated in scope of current transaction', test(function (done) {
  ...
  it('should create new translations for an entity that was not changed in scope of the current transaction (only translations for it were updated)', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      from: 42424242
  ...
  it('stops translations processing if error occurred while creating new version of translations target with translations added', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      from: 42424242
  ...
  it('stops translations processing translation target was not found, simply because we cannot translate NON EXISTENT THING', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      from: 42424242
  ...
  it('stops translations processing when error occurred during translation target search', test(function (done) {
    const expectedError = 'Boo!';
  ...
  it('stops translations processing if it is impossible to find a translation target', test(function (done) {
    const repoStub: any = {
  ...
  it('should remove translations for an entity that was removed in scope of current transaction', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
  ...
  it('should remove translations for an entity that was removed not in scope of the current transaction', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      to: 42424242
  ...
  it('should not remove translations from target when error occurred during target searching', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      to: 42424242
  ...
  it('should stops removing translation if translation target was not found', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      to: 42424242
...
describe('Translations processing: handle "change" events', () => {
  it('should update existing translations on targets', test(function (done) {
    const translationTarget: any = {
      _id: '_id',
      originId: 'originId',
      from: externalContext.version,
