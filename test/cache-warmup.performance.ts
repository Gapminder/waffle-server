...
const repos = [
  ...
  { url: 'git@github.com:open-numbers/ddf--gapminder--systema_globalis.git#stage' },
  { url: 'git@github.com:open-numbers/ddf--gapminder--population.git#stage' }
];
...
const externalContext = {
  ...
  defaultDatasetName: 'open-numbers/ddf--gapminder--systema_globalis#stage',
  defaultDatasetPath: 'git@github.com:open-numbers/ddf--gapminder--systema_globalis.git#stage',
