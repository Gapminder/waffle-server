...
import * as fixtureSchemaConcepts from './fixtures/commit-3--schema-concepts.json';
import * as fixtureSchemaEntities from './fixtures/commit-3--schema-entities.json';
import * as fixtureSchemaDatapoints from './fixtures/commit-3--schema-datapoints.json';
import * as fixtureSchemaDatapointsMinMax from './fixtures/commit-3--schema-datapoints--min-max.json';
import * as fixtureSchemaDatapointsAvg from './fixtures/commit-3--schema-datapoints--avg.json';
import * as fixtureDataConcepts from './fixtures/commit-3--data-concepts.json';
import * as fixtureDataEntities from './fixtures/commit-3--data-entities.json';
import * as fixtureDataEntitiesSpeakingEnglish from './fixtures/commit-3--data-entities-speakingenglish.json';
import * as fixtureDataEntitiesFoundation from './fixtures/commit-3--data-entities-foundation.json';
import * as fixtureDataEntitiesCompanySize from './fixtures/commit-3--data-entities-companysize.json';
import * as fixtureDataConceptsEntitySet from './fixtures/commit-3--data-concepts-etityset.json';
import * as fixtureDataConceptsMeasure from './fixtures/commit-3--data-concepts-measure.json';
import * as fixtureDataConceptsString from './fixtures/commit-3--data-concepts-string.json';
import * as fixtureDatapointsLinesOfCodeByCompanyAnno from './fixtures/commit-3--datapoints-linesofcode_by_company_anno.json';
import * as fixtureDatapointsCompanySizeByCompanyAnno from './fixtures/commit-3--datapoints-companysize_by_company_anno.json';
import * as fixtureDatapointsLinesOfCodeByCompanyProject from './fixtures/commit-3--datapoints-linesofcode_by_company_project.json';
import * as fixtureDatapointsLinesOfCodeByCompanyProjectAnno from './fixtures/commit-3--datapoints-linesofcode_by_company_project_anno.json';
import * as fixtureDatapointsNumUsersByCompanyProject from './fixtures/commit-3--datapoints-numusers_by_company_project.json';
import * as fixtureQueryOperatorsLinesOfCodeByCompanyAnnoWithCondition from './fixtures/commit-3--operators-linesofcode_by_company_anno.json';
import * as fixtureQueryOperatorsCompanySizeByCompanyAnnoWithCondition from './fixtures/commit-3--operators-companysize_by_company_anno.json';
import * as fixtureQueryOperatorsLinesOfCodeByCompanyProjectWithCondition from './fixtures/commit-3--operators-linesofcode_by_company_project.json';
import * as fixtureQueryOperatorsLinesOfCodeByCompanyProjectAnnoWithCondition from './fixtures/commit-3--operators-linesofcode_by_company_project_anno.json';
import * as fixtureQueryOperatorsNumUsersByCompanyProjectWithCondition from './fixtures/commit-3--operators-numusers_by_company_project.json';
import * as fixtureDatapointTranslationsCompanySize from './fixtures/commit-3--translations-datapoints-company_size.json';
import * as fixtureEntityTranslationsCompanySize from './fixtures/commit-3--translations-entities-company_size.json';
import * as fixtureEntityTranslationsRegion from './fixtures/commit-3--translations-entities-region.json';
import * as fixtureEntityTranslationsCompany from './fixtures/commit-3--translations-entities-company.json';
import * as fixtureConceptsTranslations from './fixtures/commit-3--translations-concepts.json';
...
describe('State Version 3 (3rd commit)', function() {
  ...
  before(() => {
    ...
    config.DEFAULT_DATASETS_VERSION = e2eEnv[INDEX_OF_THIRD_COMMIT];
  });
