...
import * as fixtureSchemaConcepts from './fixtures/commit-1--schema-concepts.json';
import * as fixtureSchemaEntities from './fixtures/commit-1--schema-entities.json';
import * as fixtureSchemaDatapoints from './fixtures/commit-1--schema-datapoints.json';
import * as fixtureSchemaDatapointsMinMax from './fixtures/commit-1--schema-datapoints--min-max.json';
import * as fixtureSchemaDatapointsAvg from './fixtures/commit-1--schema-datapoints--avg.json';
import * as fixtureDataConcepts from './fixtures/commit-1--data-concepts.json';
import * as fixtureDataEntities from './fixtures/commit-1--data-entities.json';
import * as fixtureDataEntitiesSpeakingEnglish from './fixtures/commit-1--data-entities-speakingenglish.json';
import * as fixtureDataEntitiesFoundation from './fixtures/commit-1--data-entities-foundation.json';
import * as fixtureDataEntitiesCompanySize from './fixtures/commit-1--data-entities-companysize.json';
import * as fixtureDataConceptsEntitySet from './fixtures/commit-1--data-concepts-etityset.json';
import * as fixtureDataConceptsMeasure from './fixtures/commit-1--data-concepts-measure.json';
import * as fixtureDataConceptsString from './fixtures/commit-1--data-concepts-string.json';
import * as fixtureDatapointsLinesOfCodeByCompanyAnno from './fixtures/commit-1--datapoints-linesofcode_by_company_anno.json';
import * as fixtureDatapointsCompanySizeByCompanyAnno from './fixtures/commit-1--datapoints-companysize_by_company_anno.json';
import * as fixtureDatapointsLinesOfCodeByCompanyProject from './fixtures/commit-1--datapoints-linesofcode_by_company_project.json';
import * as fixtureDatapointsLinesOfCodeByCompanyProjectAnno from './fixtures/commit-1--datapoints-linesofcode_by_company_project_anno.json';
import * as fixtureDatapointsNumUsersByCompanyProject from './fixtures/commit-1--datapoints-numusers_by_company_project.json';
import * as fixtureQueryOperatorsLinesOfCodeByCompanyAnnoWithCondition from './fixtures/commit-1--operators-linesofcode_by_company_anno.json';
import * as fixtureQueryOperatorsCompanySizeByCompanyAnnoWithCondition from './fixtures/commit-1--operators-companysize_by_company_anno.json';
import * as fixtureQueryOperatorsLinesOfCodeByCompanyProjectWithCondition from './fixtures/commit-1--operators-linesofcode_by_company_project.json';
import * as fixtureQueryOperatorsLinesOfCodeByCompanyProjectAnnoWithCondition from './fixtures/commit-1--operators-linesofcode_by_company_project_anno.json';
import * as fixtureQueryOperatorsNumUsersByCompanyProjectWithCondition from './fixtures/commit-1--operators-numusers_by_company_project.json';
import * as fixtureDatapointTranslationsCompanySize from './fixtures/commit-1--translations-datapoints-company_size.json';
import * as fixtureEntityTranslationsCompanySize from './fixtures/commit-1--translations-entities-company_size.json';
...
describe('Initial State, Version 1 (1st commit)', function() {
