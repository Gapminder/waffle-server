...
const ddfEntitiesForPostRequestJsonFormat = require('./ws_ddf_test_fixtures_last_commit/entities-with-select-json-format.json');
const ddfEntitiesForPostRequestWsJsonFormat = require('./ws_ddf_test_fixtures_last_commit/entities-with-select-wsjson-format.json');
const ddfEntitiesForPostRequestDdfJsonFormat = require('./ws_ddf_test_fixtures_last_commit/entities-with-select-ddfjson-format.json');
