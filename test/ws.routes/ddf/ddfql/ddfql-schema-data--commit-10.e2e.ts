...
import * as fixtureDatapointTranslationsPopularityAndMeetingTypeAndMethodology from './fixtures/commit-10--translations-datapoints-meeting_style-popular_appeal-methodology.json';
import * as fixtureDatapointTranslationsWithoutDimensionAnno from './fixtures/commit-10--translations-datapoints-meeting_style-popular_appeal-methodology-without-dimension-anno.json';
