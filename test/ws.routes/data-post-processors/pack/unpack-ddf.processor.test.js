...
const unpackProcessor = require('./../../../../ws.routes/data-post-processors/pack/unpack-ddf.processor.js');

const expect = chai.expect;

describe('data post processors unpack ddf', () => {
  it('should ddfJson concept data into json format', () => {
    const packedJson = require('./../../../../ws.routes/data-post-processors/fixtures/ddf-json-concepts.json');
  ...
  it('should unpack ddfJson entities data into json format', () => {
    const packedJson = require('./../../../../ws.routes/data-post-processors/fixtures/ddf-json-entities.json');
    const expectedHeaders = [
      "country",
      "gwid",
      "name",
  ...
  it('should unpack ddfJson datapoints data into json format', () => {
    const packedJson = require('./../../../../ws.routes/data-post-processors/fixtures/ddf-json-datapoints.json');
    const expectedHeaders = [
      "energy_use_total",
      "geo",
      "sg_population",
