...
import { testsDescriptors } from 'vizabi-ddfcsv-reader/dist/test-cases-entities';
...
export const entitiesAgTestSuitesCompletes: TestSuitesComplete[] = [];
...
for (const description of descriptions) {
  ...
  entitiesAgTestSuitesCompletes.push(conceptsTestSuitesComplete);
}

for (const conceptsTestSuitesComplete of entitiesAgTestSuitesCompletes) {
