...
import ddfEntitiesCountryJsonFormat from './ws_ddf_test_fixtures_first_commit/entities-for-get-with-params-json-format.json'
import ddfEntitiesCountryWsJsonFormat from './ws_ddf_test_fixtures_first_commit/entities-for-get-with-params-wsjson-format.json';
import ddfEntitiesCountryDdfJsonFormat from './ws_ddf_test_fixtures_first_commit/entities-for-get-with-params-ddfjson-format.json';
