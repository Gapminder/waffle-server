...
import ddfEntitiesForPostRequestJsonFormat from './ws_ddf_test_fixtures_second_commit/entities-with-select-json-format.json';
import ddfEntitiesForPostRequestWsJsonFormat from './ws_ddf_test_fixtures_second_commit/entities-with-select-wsjson-format.json';
import ddfEntitiesForPostRequestDdfJsonFormat from './ws_ddf_test_fixtures_second_commit/entities-with-select-ddfjson-format.json';
