...
import ddfConceptsJsonFormat from './ws_ddf_test_fixtures_last_commit/concepts-without-params-json.json';
import ddfConceptsWsJsonFormat from './ws_ddf_test_fixtures_last_commit/concepts-without-params-wsjson.json';
import ddfConceptsDdfJsonFormat from './ws_ddf_test_fixtures_last_commit/concepts-without-params-ddfjson.json';
...
function setDefaultLastCommitByCLI(onSetDefaultLastCommitByCLIDone) {
  ...
  return shell.exec(setDefaultcommand, (error) => {
    ...
    return onSetDefaultLastCommitByCLIDone(error);
  })
}
