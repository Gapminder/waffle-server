...
const PARAMS = `${NODE_ENV} ${CLEAR_ALL_MONGO_DB_COLLECTIONS_BEFORE_IMPORT} ${LOG_LEVEL} ${LOG_TRANSPORTS} ${SESSION_SECRET} ${GOOGLE_CLIENT_ID} ${GOOGLE_CLIENT_SECRET} ${MONGODB_URL} ${NEO4J_URL}`;
