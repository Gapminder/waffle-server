...
const config: any = {
  ...
  PATH_TO_GCP_SERVICE_ACCOUNT_FILE: process.env.PATH_TO_GCP_SERVICE_ACCOUNT_FILE,
  GCP_STORAGE_BUCKET_NAME: process.env.GCP_STORAGE_BUCKET_NAME,
...
const REQUIRED_ENVIRONMENT_VARIABLES = Object.freeze([
  'HOSTNAME', 'S3_BUCKET', 'S3_ACCESS_KEY', 'S3_SECRET_KEY', 'GCP_PROJECT_ID', 'PATH_TO_GCP_SERVICE_ACCOUNT_FILE', 'GCP_STORAGE_BUCKET_NAME'
]);
