...
function iboxTools($timeout) {
  return {
    restrict: 'A', scope: true, templateUrl: 'views/common/ibox_tools.html', controller: function ($scope, $element) {
    ...
    restrict: 'A', scope: {
      ...
      element.vectorMap({
        map: 'world_mill_en', backgroundColor: 'transparent', regionStyle: {
          ...
          regions: [{
            values: scope.myMapData, scale: ['#1ab394', '#22d6b1'], normalizeFunction: 'polynomial'
          }]
        },
      });
    }
...
function dropZone() {
  return function (scope, element, attrs) {
    element.dropzone({
      url: '/upload', maxFilesize: 100, paramName: 'uploadfile', maxThumbnailFilesize: 5, init: function () {
