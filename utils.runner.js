...
const GOOGLE_CLIENT_ID = process.env.GOOGLE_CLIENT_ID ? `GOOGLE_CLIENT_ID=${process.env.GOOGLE_CLIENT_ID}` : '';
const GOOGLE_CLIENT_SECRET = process.env.GOOGLE_CLIENT_SECRET ? `GOOGLE_CLIENT_SECRET=${process.env.GOOGLE_CLIENT_SECRET}` : '';
...
module.exports = {
  ...
  config: {
    NODE_ENV, LOG_LEVEL, LOG_TRANSPORTS, SESSION_SECRET, GOOGLE_CLIENT_ID,
    GOOGLE_CLIENT_SECRET, MONGODB_URL, NEO4J_URL,
