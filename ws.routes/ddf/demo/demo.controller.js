...
const reposService = require('../import/repos.service.js');
...
module.exports = (serviceLocator) => {
  ...
  function sendUpdateIncrementally(req, res) {
    let pipe = {
    ...
    //service.updateIncrementally(req.query,
