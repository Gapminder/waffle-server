...
function mapSchemaToWsJson(data) {
  ...
  return { name: data.datasetName, version: data.transaction.commit, headers, rows: sortRows(rows, data.query, headers)};
}
...
function mapConceptToWsJson(data) {
  ...
  return { name: data.datasetName, version: data.transaction.commit, headers: select, rows: sortRows(rows, data.query, data.headers) };
}
...
function mapDatapointsToWsJson(data) {
  ...
  return {
    ...
    version: data.transaction.commit,
