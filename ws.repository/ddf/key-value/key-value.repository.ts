...
KeyValueRepository.prototype.set = function (key: any, value: any, onSet: any): any {
  return KeyValue.update({key}, {$set: {value}}, {upsert: true}, onSet);
};

KeyValueRepository.prototype.get = function (key: any, defaultValue: any, onGot: any): any {
