...
DatasetTransactionsRepository.prototype.removeAllByDataset = function (datasetId: any, done: any): any {
...
DatasetTransactionsRepository.prototype.setLastError = function (transactionId: any, lastErrorMessage: string, done: any): any {
  return DatasetTransactions.findOneAndUpdate({_id: transactionId}, {$set: {lastError: lastErrorMessage}}, {new: true}, done);
};

DatasetTransactionsRepository.prototype.create = function (transaction: any, onCreated: any): any {
...
DatasetTransactionsRepository.prototype.closeTransaction = function ({transactionId, transactionStartTime}: any, onClosed: any): any {
  if (!transactionId) {
...
DatasetTransactionsRepository.prototype.establishForDataset = function ({transactionId, datasetId}: any, onEstablished: any): any {
  if (!transactionId) {
...
DatasetTransactionsRepository.prototype.updateLanguages = function ({languages, transactionId}: any, onLanguagesUpdated: any): any {
  if (!transactionId) {
    return onLanguagesUpdated('TransactionId is required');
  }

  return DatasetTransactions.findOneAndUpdate({_id: transactionId}, {$set: {languages}}, {new: true}, onLanguagesUpdated);
};

DatasetTransactionsRepository.prototype.findDefault = function (options: any, onDefaultFound: any): Promise<Object> {
...
DatasetTransactionsRepository.prototype.setAsDefault = function (userId: any, datasetId: any, transactionId: any, onSetAsDefault: any): any {
